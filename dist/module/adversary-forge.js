...
export async function openAdversaryForge({template=null,file=null}={}){
 ...
 let previewUrl=null;
 try{
 const base=template?copyAdversaryTemplate(template):null;
