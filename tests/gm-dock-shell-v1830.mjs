...
assert.ok(Number(manifest.version.split(".").at(-1)) >= 1830, "manifest must retain the v0.0.1830 GM Dock baseline");
...
assert.doesNotMatch(runtime, /\.update\(|setFlag\(/, "v0.0.1830 shell must not mutate gameplay state");
