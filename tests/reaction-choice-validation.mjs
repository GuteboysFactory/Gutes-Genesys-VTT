...
const c=vm.createContext({SYSTEM_ID:'genesys-vtt',isWinded:()=>false,getEligibleReactions:r=>r,formatReactionCost:()=>'',game:{user:{id:'gm'},users:{contents:[]}},foundry:{applications:{api:{DialogV2:{wait:async()=>result}}}}});vm.runInContext(s,c);
