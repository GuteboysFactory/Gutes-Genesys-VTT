# Historical roadmap — through v0.0.1889

Archived before the post-v1889 release-planning update. This file preserves historical plans and reports; its pending gates are not the current backlog. See [current roadmap](../ROADMAP.md) and [remaining-work report](REMAINING_WORK_AFTER_V1889.md).
